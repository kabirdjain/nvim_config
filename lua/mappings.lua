...
-- Open neovim config, which is plugin_specs.lua
keymap.set("n", "<leader>ep", "<cmd>tabnew ~/.config/nvim/lua/plugin_specs.lua <bar> tcd %:h<cr>", {
  silent = true,
  desc = "open plugins",
})

-- source and reload the nvim config
...
-- open snacks.nvim tree
keymap.set("n", "<leader>tr", "<cmd>lua Snacks.explorer.open()<cr>", {
  silent = true,
  desc = "open Snacks.nvim tree",
})

-- open snacks.nvim terminal
keymap.set("n", "<leader>te", "<cmd>lua Snacks.terminal.toggle()<cr>", {
  silent = true,
  desc = "open Snacks.nvim terminal ONCE",
})

-- open multiple snacks.nvim terminals if needed
keymap.set("n", "<leader>tm", "<cmd>lua Snacks.terminal.open()<cr>", {
  silent = true,
  desc = "open Snacks.nvim terminal if more terminals are needed",
})
